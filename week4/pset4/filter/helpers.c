...
// for each of the helper functions, we use a higher order procedure
// image_map is a function which iterates through height, then width
// this is because there is a general pattern here (nested mapping) which we can exploit to abstract into a reusable function.
